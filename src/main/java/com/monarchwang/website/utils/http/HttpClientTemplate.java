...
public class HttpClientTemplate {
	...
	public String executePost(String url, String stringEntity)
		...
		logger.info("HttpClientTemplate response from url={}, entity={}, data={}", url, stringEntity, result);
		return result;
	}
	...
	private HttpPost makePostRequest(String url, String stringEntity) throws IOException {
		...
		if (stringEntity != null) {
			...
			post.setEntity(se);
			logger.info("HttpClientTemplate making post request url={}, entity={}", url, stringEntity);
		}
		return post;
	}
...
//		postMethod.addHeader("signature", "qincang2fcf17f9427r4bdb886cydcf47633t91");
		return postMethod;
	}
